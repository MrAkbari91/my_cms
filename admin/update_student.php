                        ...
                        <div class="basic-form">
                            <form method="post" action="query.php" enctype="multipart/form-data">
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" value="<?php if (isset($row['sid'])){echo $row['sname'];} ?>" name="update_student_name">
                                    </div>
                                </div>
                                <div class="mb-3 row">
                                    <label class="col-sm-3 col-form-label">Email</label>
                                    <div class="col-sm-9">
                                        <input type="email" class="form-control" value="<?php if (isset($row['sid'])){echo $row['email'];} ?>" name="update_student_email">
                                    </div>
                                </div>
                                <div class="mb-3 row">
                                    <label class="col-sm-3 col-form-label">Occupation</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" value="<?php if (isset($row['sid'])) {echo $row['occ'];} ?>" name="update_occupation">
                                    </div>
                                </div>
                                <div class="mb-3 row">
                                    <label class="col-sm-3 col-form-label">Password</label>
                                    <div class="col-sm-9">
                                        <input type="password" class="form-control" value="<?php if (isset($row['sid'])){echo $row['pwd'];} ?>" name="update_password">
                                    </div>
                                </div>
                                <div class="input-group custom_file_input">
                                    ...
                                    <div class="input-group custom_file_input">
                                        <div class="form-file">
                                            <input type="file" class="form-file-input form-control" name="update_student_img" id="update_student_img" value="<?php if (isset($row['sid'])){echo $row['img'];} ?>">
                                        </div>
                                    </div>
                                </div>
                                <div class="mb-3 row">
